...
Dados("que quando pesquiso o RG da pessoa na tela de Pessoas.") do
  user_page.load
...
Então("o sistema retorna os dados conforme RG utilizado.") do
  #find(:xpath, 'input#rgInput.ivu-input xh-highlight')
  #find(:css, //div[1]/div[@id='rg']//div[@class='d-inline-block']/label", text: "RG", exact: true)"
