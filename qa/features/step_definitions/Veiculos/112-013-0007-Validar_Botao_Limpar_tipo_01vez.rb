Dado("que estou na tela de Veiculos.") do
    ...
    Dado("preenchi somente o campo tipo.") do
  ...
  Quando("e após, clico eu sobre o botão “Limpar” da pagina.") do
    sleep(2)
    user_page.bt_limpar
    sleep(2)
  end
  
  Então("o sistema limpa todos os dados da pagina de pesquisa.") do
     sleep(1)
