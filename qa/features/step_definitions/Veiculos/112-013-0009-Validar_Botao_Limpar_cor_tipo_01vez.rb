Dado("que permaneço na tela de Veiculos.") do
    ...
    Dado("seleciono uma opção nos campos cor e tipo.") do
        sleep(1)
  ...
  Quando("clico eu sobre o botão “Limpar” da pagina após a seleção.") do
    sleep(2)
    user_page.bt_limpar
    sleep(2)
  end
  
  Então("o sistema limpa todos os dados da pagina de pesquisa com sucesso.") do
     sleep(1)
