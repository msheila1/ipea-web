Dado("que eu continue na tela de Veiculos.") do
  ...
  Dado("preencha somente o campo cor novamente.") do
  ...
  Quando("clico eu sobre o botão “Limpar” da pagina novamente.") do
    sleep(2)
    user_page.bt_limpar
    sleep(2)
  end
  
  Então("o sistema limpa todos os dados da pagina novamente.") do
    sleep(1)
