Dado("que acessei o Menu Veículo.") do
  ...
  Dado("realizei uma pesquisa com sucesso.") do
        sleep(2)
  ...
  Quando("clico eu sobre o botão “Limpar”.") do
    sleep(1)
        user_page.bt_limpar
  end
  
  Então("o sistema limpa todos os dados da pesquisa.") do
     sleep(1)
