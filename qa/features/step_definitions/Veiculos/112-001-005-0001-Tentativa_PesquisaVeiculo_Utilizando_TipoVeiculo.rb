Dado("que estou na tela de pesquisa de Veículos - Somente Tipo de Veículo.") do
  user_page.load
  ...
  Quando("preencho a Cor do Veículo e pesquiso - Somente Tipo de Veículo.") do
    sleep(1)
  ...
  Então("verifico se o sistema retornou a mensagem Adicione placa ou chassi ou municipio - Somente Tipo de Veículo.") do
