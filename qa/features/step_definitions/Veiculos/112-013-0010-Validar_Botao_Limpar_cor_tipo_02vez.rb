Dado("que continuo na tela de Veiculos.") do
    ...
    Dado("selecionei cor e tipo, limpei e selecionei cor e tipo novamente.") do
        sleep(1)
  ...
  Quando("clico eu sobre o botão “Limpar” da pagina após as seleções.") do
    sleep(2)
    user_page.bt_limpar
    sleep(2)
  end
  
  Então("o sistema efetua a limpeza de todos os dados da pagina novamente.") do
     sleep(1)
