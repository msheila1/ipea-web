Dado("que acessei a tela de busca por veículo.") do
    ...
    Dado("preenchi toso os campos, limpei e preenchi novamente.") do
    sleep(2)
  ...
  Quando("eu clico sobre o botão “Limpar”.") do
    sleep(1)
    user_page.bt_limpar
  end
  
  Então("o sistema limpa todos os dados novamente.") do
    sleep(1)
