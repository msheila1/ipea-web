  ...
  sleep(1)
   ...
   #validação dados pegos de planilha
    ...
    @logado = data_login.sheet('data_login').cell('E', 3).to_s # Para usuário Logado    
    ...
    @pagina = data_login.sheet('data_login').cell('F', 3).to_s # Para texto identificador da página 
