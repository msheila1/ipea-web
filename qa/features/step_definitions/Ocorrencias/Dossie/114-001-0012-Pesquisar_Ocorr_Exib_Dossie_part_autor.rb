Dados("que acesso a tela de Ocorrência, efetuo uma pesquisa com sucesso e visualizo o autor.") do
    user_page.load
  ...
  Quando("eu seleciono uma ocorrência no grid,  visualizo o Dossie e clico no Link Partes Envolvidas visualizo o autor e clico no registro.") do
    sleep(1) 
    ...
    user_page.partes_env
    sleep(2) 
    user_page.visualizar_autor
    sleep(2) 
  end

  Então("o sistema exibe mensagem de Nenhum registro encontrado.") do
     sleep(2) 
