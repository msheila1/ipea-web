Dados("que acesso a tela de Ocorrência, efetuo uma pesquisa de Ocorrencia valida.") do
    user_page.load
  ...
  Quando("eu seleciono uma ocorrência no grid,  visualizo o Dossie, clico no Link Auto de Reconhecimento Fotográfico e seleciono {int} registro.") do |int|
    sleep(1) 
  ...
  Então("o sistema exibe o documento de Auto de Reconhecimento Fotográfico conforme pesquisado.") do
    sleep(2) 

    find('span', text: 'Total de 56 registros', exact: true)

    user_page.clicar_auto_rec
    sleep(2)
