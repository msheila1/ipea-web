 Dados("que acesso a tela de Ocorrência, efetuo uma pesquisa e valido o histórico Completo.") do
    user_page.load
  ...
  Quando("eu seleciono uma ocorrência no grid e clico no botão de Visualização e clico em Leia Mais.") do
    sleep(1) 
  ...
  Então("o sistema exibe o histórico Completo no dossie da ocorrência") do
  sleep(2) 
