      ...
      <div class="row">
        ...
        <div class="col-sm">
          <el-form-item prop="fieldAutocomplete">
            ...
            <el-autocomplete v-model="model.fieldAutocomplete" value-key="label" :fetch-suggestions="onAutocomplete" :debounce="1000" placeholder="Digite o termo de pesquisa" class="w-100">
